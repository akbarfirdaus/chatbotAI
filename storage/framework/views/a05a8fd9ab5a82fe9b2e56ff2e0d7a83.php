...
<div class="head-title">
	<div class="left">
		<h1>Report</h1>
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/client/report/style.css')); ?>">
		<ul class="breadcrumb">
			<li>
				<a class="active" href="<?php echo e(route('dashboard.client')); ?>">Dashboard</a>
			</li>
        ...
        <table>
            ...
            <tbody id="patient-data">
                <tr data-month="06" data-year="2024">
                    ...
                    <td>2024</td>
                    <td>
                    <a href="<?php echo e(route('report.riwayat')); ?>">
...
<script src=<?php echo e(asset("assets/client/report/script.js")); ?>></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('pointakses.client.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\chatbot\resources\views\pointakses\client\report\report.blade.php ENDPATH**/ ?>