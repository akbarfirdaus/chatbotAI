...
<div class="head-title">
	<div class="left">
		<h1>Report</h1>
        <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/admin/report/style.css')); ?>">
		<ul class="breadcrumb">
			<li>
...
<script src=<?php echo e(asset("assets/admin/report/script.js")); ?>></script>
</body>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('pointakses.admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\chatbot\resources\views\pointakses\admin\report\index.blade.php ENDPATH**/ ?>