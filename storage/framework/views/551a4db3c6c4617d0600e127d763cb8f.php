...
<section id="sidebar">
    <a href="<?php echo e(route('dashboard.client')); ?>" class="brand">
        <i class='bx bx-message-dots'></i>
        <span class="text">MentalBot</span>
    </a>
    <ul class="side-menu top">
        <li id="menu-dashboard">
            <a href="<?php echo e(route('dashboard.client')); ?>">
                <i class='bx bxs-dashboard'></i>
                <span class="text">Dashboard</span>
            </a>
        </li>
        <li id="menu-konsultasi">
            <a href="<?php echo e(route('konsultasi.client')); ?>">
                <i class='bx bx-conversation'></i>
                <span class="text">Konsultasi</span>
            </a>
        </li>
        <li id="menu-report">
            <a href="<?php echo e(route('report.client')); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
	...
	if (currentPath === '<?php echo e(route('dashboard')); ?>' || currentPath.includes('dashboard.client')) {
...
<?php /**PATH C:\laragon\www\chatbot\resources\views\template\client\sidebar.blade.php ENDPATH**/ ?>