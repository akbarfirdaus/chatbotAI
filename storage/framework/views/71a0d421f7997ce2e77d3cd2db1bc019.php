...
<section id="sidebar">
	...
	<ul class="side-menu top">
		...
		<li id="menu-data-gejala">
			<a href="<?php echo e(route('data_gejala')); ?>">
...
document.addEventListener('DOMContentLoaded', function() {
	...
	if (currentPath === '<?php echo e(route('dashboard')); ?>' || currentPath.includes('dashboard')) {
...
<?php /**PATH C:\laragon\www\chatbot\resources\views\template\admin\sidebar.blade.php ENDPATH**/ ?>